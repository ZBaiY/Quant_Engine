# quant_engine/data/derivatives/chain_handler.py
...
class OptionChainDataHandler:
    ...
    # ----------------------------------------------------------------------
    def load_initial(self, chains: List[OptionChain]):
        """
        Load a list of OptionChain objects. (Backtesting)
        """
        for chain in chains:
